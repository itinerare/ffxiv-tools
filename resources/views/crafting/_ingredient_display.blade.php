<li>
    ...
    @include('_item_price_display', ['priceData' => $ingredient['priceData'], 'displayHQ' => $ingredient['recipe'] ? $recipe->can_hq : false, 'effectiveCost' => $ingredient['effective_cost'] ?? null])
